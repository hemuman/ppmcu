...
public class SliderDemo extends JPanel
    ...
    String[] ImagePaths;
    public SliderDemo(String[] ImagePaths) {
        
         NUM_FRAMES = ImagePaths.length;
    ...
    protected void updatePicture(int frameNum) {
        ...
        if (images[frameNumber] == null) {
            images[frameNumber] = createImageIcon(ImagePaths[frameNumber]);
        }
        ...
        if (images[frameNumber] != null) {
         ...
         images[frameNumber] =null;//After play
    }
    ...
    public static  void createAndShowGUI(String[] Paths) {
        //Create and set up the window.
        JFrame frame = new JFrame("SliderDemo");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        SliderDemo animator = new SliderDemo(Paths);
