...
public class BoundingCurvesFinderDTask extends DistributedTask {
    ...
    public BoundingCurvesFinderDTask(double[][] RackDimensions, double[][] IntesectionData, double PinionSectionAccuracy, int NumberOfPointsOnRack, double YAccuracy, double ScatterThreshold) {
    ...
    public Vector compute() {
       Vector result=new Vector();
        ...
        double[][] tempIntesectionData = GO.getPointsOnZPlane(IntesectionData, PinionSectionAccuracy);
             ...
             * Bounding Box Method
             */
            Vector boundary = GO.getBoundaryPointsMCW(tempIntesectionData, YAccuracy, ScatterThreshold, RackDimensions[1][1], RackDimensions[0][1], true);
